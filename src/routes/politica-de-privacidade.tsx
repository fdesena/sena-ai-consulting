      ...
      <div className="prose prose-neutral mt-8 max-w-none space-y-6 text-sm leading-relaxed text-foreground/90">
        ...
        <section>
          ...
          <ul className="list-disc pl-6">
            ...
            <li>
              Nome, telefone e conteúdo das mensagens de clientes dos nossos clientes, quando
              operamos integrações de WhatsApp Business em nome deles.
            </li>
          </ul>
          <p>
            Nesse último caso atuamos como operadores: os dados pertencem ao nosso cliente
            contratante, que define as finalidades do tratamento.
          </p>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc pl-6">
            <li>
              Responder dúvidas e conduzir conversas comerciais, inclusive por automações de
              WhatsApp;
            </li>
        ...
        <section>
          ...
          <p>
            Não vendemos seus dados. Tratamos dois conjuntos de dados independentes, em
            infraestruturas separadas, e cada prestador tem acesso apenas ao conjunto indicado
            abaixo.
          </p>
          <p>
          ...
          <p>
            Dados das integrações de WhatsApp Business — nome, telefone e conteúdo das mensagens
            trocadas entre nossos clientes e os clientes deles:
          </p>
          <ul className="list-disc pl-6">
        ...
        <section>
          ...
          <p>
            Mantemos seus dados pelo tempo necessário para os fins descritos acima ou conforme
            exigido por lei. Você pode solicitar a exclusão dos seus dados a qualquer momento
        ...
        <section>
          ...
          <p>
            De acordo com a LGPD (Lei nº 13.709/2018) e, quando aplicável, o GDPR, você tem direito
            a acessar, corrigir, portar ou solicitar a exclusão dos seus dados pessoais, além de
            revogar consentimento para comunicações a qualquer momento.
          </p>
        </section>
