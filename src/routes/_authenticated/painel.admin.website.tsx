  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6 text-zinc-100">
      <div>
        ...
        <p className="text-sm text-zinc-400">Acompanhe o tráfego do site e gerencie o conteúdo da seção Experiências internacionais.</p>
      </div>
        ...
        {tabs.map((t) => {
          ...
          return (
            <Link
              key={t.to}
              to={t.to}
              className={`inline-flex items-center gap-2 px-4 py-2.5 text-sm font-medium border-b-2 -mb-px ${active ? "border-bronze text-bronze" : "border-transparent text-zinc-400 hover:text-zinc-200"}`}
            >
