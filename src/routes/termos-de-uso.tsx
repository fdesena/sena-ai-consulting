    ...
    <main className="mx-auto max-w-3xl px-6 py-16 text-foreground">
      ...
      <div className="prose prose-neutral mt-8 max-w-none space-y-6 text-sm leading-relaxed text-foreground/90">
        ...
        <section>
          ...
          <p>
            A Sena Labs oferece serviços de consultoria em inteligência artificial, automação e
            transformação digital, incluindo o diagnóstico de oportunidades disponível em{" "}
            <Link to="/diagnostico" className="underline">
              /diagnostico
            </Link>
            , implementação de sistemas e capacitação. O conteúdo do site é informativo e comercial,
            não constituindo relação contratual até a formalização de uma proposta.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            Labs ou licenciados a ela, protegidos pela legislação de direitos autorais e propriedade
        ...
        <section>
          ...
          <p>
            ...
            . Para iniciar o diagnóstico de oportunidades, pedimos seu consentimento explícito antes
            de coletar nome, e-mail, WhatsApp e, opcionalmente, o nome do seu negócio — base legal:
            consentimento (Art. 7º, I, da LGPD). Você pode solicitar acesso, correção ou exclusão
        ...
        <section>
          ...
          <p>
            ...
            personalizada do seu negócio. A Sena Labs não se responsabiliza por decisões tomadas
