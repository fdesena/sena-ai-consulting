  ...
  <Html lang="pt-BR" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={p}>
          Criamos uma conta para você acessar o seu diagnóstico completo e o plano de 30 dias a
          qualquer momento.
        </Text>
        ...
        <Section style={box}>
          ...
          <Text style={hint}>
            Por segurança, sua senha inicial é igual ao seu email. Troque assim que entrar, em{" "}
            <i>Perfil → alterar senha</i>.
          </Text>
        </Section>
        ...
        <Text style={p}>
          <b>1. Agende uma conversa gratuita de 30 min</b> comigo para destrincharmos juntos os seus
          resultados.
        </Text>
        <Section style={{ textAlign: "center", margin: "12px 0 20px" }}>
          <Button href={agendaUrl} style={btnAlt}>
            Agendar 30 min com Felipe
          </Button>
        </Section>
        ...
        <Section style={{ textAlign: "center", margin: "12px 0 8px" }}>
          <Button href={whatsappUrl} style={btnAlt}>
            Falar no WhatsApp
          </Button>
        </Section>
        ...
        <Text style={foot}>
          Trocar a senha:{" "}
          <Link href={perfilUrl} style={link}>
            {perfilUrl}
          </Link>
        </Text>
